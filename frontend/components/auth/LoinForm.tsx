    ...
    return (
        <div className="h-screen w-full flex items-center justify-center">
            ...
            <div className="flex border rounded-xl overflow-hidden ">
                ...
                <div className="bg-primary/80 text-white p-10 w-80 space-y-4">
                    <div>
                ...
                <div className="p-10 my-auto">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="mt-10">
                        <FieldGroup>
                            <Field>
                                <FieldLabel className="text-body-sm font-medium">Username</FieldLabel>
                            ...
                            <Button type="submit" disabled={isSubmitting} className="w-full h-12 font-semibold ">
